...
export interface Order {
  ...
  distancia_km: number;
  status: 'Pendiente' | 'Procesando' | 'En preparación' | 'En preparacion' | 'Listo' | 'En camino' | 'Entregado' | 'Cancelado' | 'pendiente_verificacion' | 'en_preparacion' | 'completado' | 'cancelado' | 'pago_enviado' | 'pendiente_pago' | 'enviado_cocina' | 'pago_en_verificacion';
